...
export declare namespace alertcenter_v1beta1 {
    ...
    class Resource$Alerts {
         ...
         */
        delete(params?: Params$Resource$Alerts$Delete, options?: MethodOptions): AxiosPromise<Schema$Empty>;
         ...
         * @return {object} Request object
         */
        get(params?: Params$Resource$Alerts$Get, options?: MethodOptions): AxiosPromise<Schema$Alert>;
         ...
         * @return {object} Request object
         */
        list(params?: Params$Resource$Alerts$List, options?: MethodOptions): AxiosPromise<Schema$ListAlertsResponse>;
    ...
    class Resource$Alerts$Feedback {
         ...
         * @return {object} Request object
         */
        create(params?: Params$Resource$Alerts$Feedback$Create, options?: MethodOptions): AxiosPromise<Schema$AlertFeedback>;
         ...
         * @return {object} Request object
         */
        list(params?: Params$Resource$Alerts$Feedback$List, options?: MethodOptions): AxiosPromise<Schema$ListAlertFeedbackResponse>;
