...
export declare const VERSIONS: {
    ...
    'v1beta4': typeof appengine_v1beta4.Appengine;
    'v1beta5': typeof appengine_v1beta5.Appengine;
};
...
export declare function appengine(version: 'v1beta4'): appengine_v1beta4.Appengine;
export declare function appengine(options: appengine_v1beta4.Options): appengine_v1beta4.Appengine;
export declare function appengine(version: 'v1beta5'): appengine_v1beta5.Appengine;
export declare function appengine(options: appengine_v1beta5.Options): appengine_v1beta5.Appengine;
