...
export declare namespace androidpublisher_v1_1 {
    ...
    class Resource$Inapppurchases {
         ...
         */
        get(params?: Params$Resource$Inapppurchases$Get, options?: MethodOptions): AxiosPromise<Schema$InappPurchase>;
    ...
    class Resource$Purchases {
         ...
         * @return {object} Request object
         */
        cancel(params?: Params$Resource$Purchases$Cancel, options?: MethodOptions): AxiosPromise<void>;
         ...
         * @return {object} Request object
         */
        get(params?: Params$Resource$Purchases$Get, options?: MethodOptions): AxiosPromise<Schema$SubscriptionPurchase>;
