...
message.guild.channels.find("name", "leader-logs").sendMessage("TB3team3 Role was Given to " + userToModify + " by " + message.author);
let TB2TEAM3ROLE = message.guild.roles.get("486675606021341204");
MENTIONED.addRole(TB2TEAM3ROLE).catch(console.error);
}
}}
else{
message.channel.send("This user does not have roles for teams 1&2.").catch(console.error);
}}); 
