...
if (msg.content === '!raid beta 4' || msg.content === '!raid Beta 4')	{
	if (msg.channel.id === '605743097435127808' || msg.channel.id === '605745454759804948') {
//                           TB1 EVENT ROOM                             TB2 EVENT ROOM
	msg.channel.bulkDelete(100)
    msg.channel.send('```To claim a lane: \n Put an 👌 emoji on the lane of choice.```');
...
//------------------------------------------------//
	...
	.setThumbnail('https://i.imgur.com/MvOD9QI.png')
	.addField('Basic Ability:', 'Target = Crossha-attack assists. Process Counterattacks.')
	.addField('Assist:', 'Target = Crossargen) 1 time(s) for each Target: Remove Taunt. ', true)
	.addField('Counter:', 'Target =Own Piercinad units from Target poo: Remove Taunt.', true)
	...
	msg.channel.bulkDelete(1)
	msg.channel.send({ files:[('.C:\Users\Jamie\discord-greeter-bot', './Character Tiers/Rocket.png')] });
	}
